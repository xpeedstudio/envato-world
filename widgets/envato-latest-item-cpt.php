...
<div class="main">
   ...
   <div class="filter-button-wraper">
      <ul id="filters" class="option-set clearfix main-filter xs_envato_product_filter" data-option-key="filter">
         <li><a href="#" data-option-value="*" class="selected">All</a></li>
         <?php foreach($category as $item): ?>
         <?php if (in_array($item, $allowed_cats)): ?>
         <li><a href="#" data-option-value=".<?php echo esc_attr($item); ?>"><?php echo esc_html(ucfirst($item=="site-templates"?"html":$item)); ?></a></li>
         <?php endif; ?>
         <?php endforeach; ?>
      </ul>
   ...
   <div class="xs_envato_product_grid">
      ...
      <?php
         ...
         ?>
      <div class="xs_envato_product_grid_item <?php echo esc_attr(str_replace(",", " ", $value_category)); ?>">
         <div class="xs_envato_single_product">
            <div class="xs_envato_entry_header">
               <div class="xs_envato_product_meta">
                  <span><i class="fa fa-<?php echo esc_attr($product_icon_class); ?> wordpress-color"
                        aria-hidden="true"></i>
                     <?php echo esc_html($item_type); ?></span>
                  <span> <i class="fa fa-cloud-download" id="download-color" aria-hidden="true"></i>
                     <?php echo ewShortNumber($value_sales); ?></span>
                  <span><i class="fa fa-tags tags-color" aria-hidden="true"></i>
                     <?php $tags = explode(',',$value_tags); echo esc_html(isset($tags[0])?$tags[0]:''); ?></span>
               </div>
               <h3 class="xs_envato_product_title"><a
                     href="<?php echo esc_url(get_the_permalink()); ?>"><?php echo esc_html(get_the_title()); ?></a></h3>
            </div>
            <div class="xs-envato-entry_thumb">
